...
<a href="https://youtube.com/live/0w30-Ua9BlY">
  <img src="https://img.youtube.com/vi/0w30-Ua9BlY/maxresdefault.jpg" alt="Dilla Microchop video walkthrough and behind-the-scenes creation" width="720">
</a>
...
├── original_sample/              # local-only sample input folder
...
Place the proof-of-concept WAV at:

```text
original_sample/Domenico_Scaratty_Sonata_Piano_Re_Minor_Domenico_Scarlatti_Sonata_For_Piano_D_Moll_3dHxqobZ90_Dmin_112bpm.wav
```

The sample filename says D minor at 112 BPM, but Dilla Microchop does not use the
sample BPM for timing. Timing comes from the generated MIDI file.

## Run The Microchop Render

```bash
./microchop_venv/bin/python microchop_sampler.py \
  --sample original_sample/Domenico_Scaratty_Sonata_Piano_Re_Minor_Domenico_Scarlatti_Sonata_For_Piano_D_Moll_3dHxqobZ90_Dmin_112bpm.wav \
  --generate-midi \
