...
from midi_config import get_bar_length_ticks, TIME_SIGNATURES, TICKS_PER_BEAT
...
def generate_bass(root: int, quality: str, scale: List[int], vc: VoiceLeadingContext,
    ...
    while root_note < 45: root_note += 12
...
def generate_harmonic_bass(root: int, quality: str, scale: List[int], vc: VoiceLeadingContext,
    ...
    root_h = chord[0]
    while root_h < 52: root_h += 12
    while root_h > 72: root_h -= 12
